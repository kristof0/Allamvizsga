...
public class VirtualDirectoryCollectionProcessing implements IState {
    MainWindowController mainWindow;

    public VirtualDirectoryCollectionProcessing(MainWindowController mainWindow) {
    ...
    public void virtualDirectoryCollectionProcessed(VirtualDirectoryCollection virtualDirectoryCollection) throws IOException {
        System.out.println("VirtualDirectoryCollectionProcessing:virtualDirectoryCollectionProcessed");
        mainWindow.setCurrentState(mainWindow.getVirtualDirectoryCollectionLoading());
        mainWindow.loadVirtualDirectoryCollection(virtualDirectoryCollection);
