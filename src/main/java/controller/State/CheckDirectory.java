...
public class CheckDirectory implements IState {
    MainWindowController mainWindow;

    public CheckDirectory(MainWindowController mainWindow) {
    ...
    public void processDirectory() throws IOException {
        System.out.println("CheckDirectory:processDirectory");
        mainWindow.setCurrentState(mainWindow.getWaitingForCollectionNameInput());
        mainWindow.getDirectoryCollectionInput();
    }
    ...
    public void directoryAlreadyProcessed(DirectoryCollection collection) throws IOException {
        System.out.println("CheckDirectory:directoryAlreadyProcessed");
