...
public class VirtualCollectionWaitingForNameInput implements IState{
    MainWindowController mainWindow;

    public VirtualCollectionWaitingForNameInput(MainWindowController mainWindow) {
    ...
    public void virtualDirectoryNameInput(String name) throws IOException {
        System.out.println("VirtualCollectionWaitingForNameInput:virtualDirectoryNameInput");
        mainWindow.setCurrentState(mainWindow.getVirtualDirectoryCollectionProcessing());
        mainWindow.createVirtualDirectoryCollection(name);
        //TODO ITT HAGYTAD ABBA
    }
    ...
    public void virtualDirectoryNameInput2(String name) throws IOException {
        ...
        mainWindow.setCurrentState(mainWindow.getVirtualDirectoryCollectionProcessing());
        try {
            mainWindow.createVirtualDirectoryCollectionOfObjects(name);
    ...
    public void virtualDirectoryNameInputFailed() {
        System.out.println("VirtualCollectionWaitingForNameInput:virtualDirectoryNameInputFailed");
