...
public class DirectoryCollectionProcessing implements IState {
    MainWindowController mainWindow;

    public DirectoryCollectionProcessing(MainWindowController mainWindow) {
    ...
    public void loadDirectoryCollection(DirectoryCollection collection) throws IOException {
        System.out.println("DirectoryCollectionProcessing:loadDirectoryCollection");
    ...
    public void directoryCollectionProcessingFinished(DirectoryCollection collection) throws IOException {
        System.out.println("DirectoryCollectionProcessing:directoryCollectionProcessingFinished");
        mainWindow.addNewDirectoryCollectionToUi(collection);
        loadDirectoryCollection(collection);
    }
