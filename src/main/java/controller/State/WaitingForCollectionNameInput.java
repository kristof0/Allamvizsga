...
public class WaitingForCollectionNameInput implements IState {
    MainWindowController mainWindow;

    public WaitingForCollectionNameInput(MainWindowController mainWindow) {
    ...
    public void directoryNameInputFailed() {
        System.out.println("WaitingForCollectionNameInput:directoryNameInputFailed");
    ...
    public void processDirectoryCollection(Collection collection) throws IOException {
        System.out.println("WaitingForCollectionNameInput:processDirectoryCollection");
        mainWindow.setCurrentState(mainWindow.getDirectoryCollectionProcessing());
        mainWindow.processDirectoryCollection(collection,mainWindow.getLastPathInput());
    }
