...
public class VirtualDirectoryCollectionLoading implements IState {
    MainWindowController mainWindow;

    public VirtualDirectoryCollectionLoading(MainWindowController mainWindow) {
    ...
    public void virtualDirectoryCollectionLoaded(VirtualDirectoryCollection virtualDirectoryCollection) throws IOException {
        System.out.println("VirtualDirectoryCollectionLoading:virtualDirectoryCollectionLoaded");
        mainWindow.setCurrentState(mainWindow.getVirtualDirectoryCollectionDisplaying());
        mainWindow.displayVirtualCollection(virtualDirectoryCollection);
