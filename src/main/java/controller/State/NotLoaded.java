...
public class NotLoaded implements IState {
    MainWindowController mainWindow;

    public NotLoaded(MainWindowController mainWindow) {
        this.mainWindow = mainWindow;
    }

    @Override
    public void createNewDirectoryCollection() throws IOException {
        System.out.println("NotLoaded:createNewDirectoryCollection");
    ...
    @Override
    public void uiSetup() {
        mainWindow.clearVirtualCollectionListView();
        mainWindow.clearFeatureListView();
        mainWindow.clearDetectedObjectsListView();
        mainWindow.enableDirectoryOpen();
        mainWindow.enableCollectionsListView();

        mainWindow.disableResetCameraButton();
        mainWindow.disableResetVirtualCollectionCameraButton();
        mainWindow.disableReorderCollectionButton();
        ...
        mainWindow.disableFeaturesListView();
        mainWindow.disableDetectedObjectsListView();
        mainWindow.disableCloseVirtualCollectionButton();
        mainWindow.disableCloseCollectionButton();
    }
    ...
    public void deleteDirectoryCollection() {
        mainWindow.deleteDirectoryCollectionWhenNotLoaded();
    }
