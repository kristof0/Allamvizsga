...
public class VirtualDirectoryCollectionWaitingForSavePathInput  implements IState{
    MainWindowController mainWindow;

    public VirtualDirectoryCollectionWaitingForSavePathInput(MainWindowController mainWindow) {
    ...
    @Override
    public void saveImagesPathInput(String savePath) throws IOException {
        mainWindow.setCurrentState(mainWindow.getVirtualDirectoryCollectionSavingToFolder());
        mainWindow.virtualDirectoryCollectionSaveSelectedImages(savePath);
    }
