...
public class AsyncScalr {
	...
	/**
	 * @see Scalr#resize(BufferedImage, Scalr.Method, int, BufferedImageOp...)
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
	...
	/**
	 * @see Scalr#resize(BufferedImage, Scalr.Mode, int, BufferedImageOp...)
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
	...
	/**
	 * @see Scalr#resize(BufferedImage, Scalr.Method, Scalr.Mode, int, BufferedImageOp...)
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
	...
	/**
	 * @see Scalr#resize(BufferedImage, Scalr.Method, int, int, BufferedImageOp...)
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
	...
	/**
	 * @see Scalr#resize(BufferedImage, Scalr.Mode, int, int, BufferedImageOp...)
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
	...
	/**
	 * @see Scalr#resize(BufferedImage, Scalr.Method, Scalr.Mode, int, int,
	 *      BufferedImageOp...)
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
											   final Scalr.Method scalingMethod, final Scalr.Mode resizeMode,
	...
	/**
	 * @see Scalr#rotate(BufferedImage, Scalr.Rotation, BufferedImageOp...)
	 */
