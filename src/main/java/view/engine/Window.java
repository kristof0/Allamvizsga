...
public class Window {
    ...
    public Window(String title, int width, int height, boolean vSync, WindowOptions opts,long other) {
        this.title = title;
        this.width = width;
        this.height = height;
        this.vSync = vSync;
    ...
    long light;
    public long otherContext;

    public synchronized long copyContext(){
        return glfwCreateWindow(width, height, title, NULL, windowHandle);
    }
    public void init() {
        ...
        // Create the window
        if(!fromOther) {
            System.out.println("Nem Fromt other");
            windowHandle = glfwCreateWindow(width, height, title, NULL, NULL);
        }
        else{
            System.out.println("Fromt other");
            windowHandle=light;
        }
        ...
        //TODO IDEGLENESEN LETILTVA AZ X GOMB
