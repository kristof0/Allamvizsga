...
public class Utils {
    ...
    public static Integer getMaxEntryInMapBasedOnValue(Map<Date,Integer> map)
    {
        // To store the result
        Map.Entry<Date, Integer> entryWithMaxValue = null;

        // Iterate in the map to find the required entry
        for (Map.Entry<Date, Integer>  currentEntry : map.entrySet()) {
    ...
    public static Integer getMaxInMapBasedOnValue(Map<Integer,Integer> map)
    {
        // To store the result
