...
public class GridView implements IGameLogic {
...
//HUD
    ...
    int[] offset;
    public GridView(IImageLoader textureLoader) {
    ...
    public GridView(IImageLoader textureLoader, int[] showedImages) {
        showed=new boolean[textureLoader.getNumberOfImages()];
    ...
    public GridView(IImageLoader textureLoader, TreeSet<Integer> showedImages) {
       ...
       k=0;
        ...
        for(;i<order.length;++i){
            ...
            if ((i != 0) && (((i) % numbeOfImagesPerTexture) == 0)) {
                ...
                System.out.println("textureAtlastIndex="+textureAtlasIndex);
