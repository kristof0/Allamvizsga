...
public class CircularDateHistogram3D implements IGameLogic {
...
//HUD
    ...
    int[] offset;
    public CircularDateHistogram3D(IImageLoader textureLoader) {
    ...
    public CircularDateHistogram3D(IImageLoader textureLoader, int[] showedImages) {
        showed=new boolean[textureLoader.getNumberOfImages()];
    ...
    public CircularDateHistogram3D(IImageLoader textureLoader, TreeSet<Integer> showedImages) {
