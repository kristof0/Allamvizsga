...
public class tSNEBasedView implements IGameLogic {
    ...
    private  int[] order;
    private transient double[][] distanceBasedPositions=null;
    ...
    private final MouseGridViewSelectionDetector selectDetector;
//HUD
    ...
    public tSNEBasedView(IImageLoader textureLoader) {
        ...
        selectDetector = new MouseGridViewSelectionDetector();
    ...
    final void  SetPosition(float[] positions,int nthPic,int nthPos){
        ...
        float x,y;
        if (distanceBasedPositions !=null){

            x=(float)distanceBasedPositions[nthPos][0];
            y=(float)distanceBasedPositions[nthPos][1];
            //System.out.println("x= "+x+" y= "+y);
        }else{
            x=(nthPos%numbeOfImagesPerRow)*pictureSize-1;
            y=1-(nthPos/numbeOfImagesPerRow)*pictureSize;
        }
        ...
        positions[j+10]=y;
        positions[j+11]=0;          // *    *
        //System.out.println("nthPic="+nthPic+" nPos="+nthPos +" x= "+x+" y="+y );
    ...
    public void init(Window window) throws Exception {
        ...
        //distanceBasedPositions=textureLoader.getDistanceBasedPositions();
